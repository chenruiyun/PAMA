...
import argparse
import yaml
from data.dataset import MVTec_Anomaly_Detection
from timm import create_model
from data import create_dataset, create_dataloader
from models import pama, MemoryBank
...
def run(cfg):
    ...
    #     wandb.init(name=cfg['EXP_NAME'], project='pama', config=cfg)
    ...
    # trainset = MVTec_Anomaly_Detection(cfg['DATASET']['target'], length=500)
...
if __name__=='__main__':
    parser = argparse.ArgumentParser(description='pama')
